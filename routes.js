...
const {getContentProperties,createContentProperties,updateContentProperties,deleteContentProperties} = require("./services/contentProperties")
...
router.delete("/contentProperties",isLoggedIn,deleteContentProperties);
